...
export const pcbBoards = {
  ...
  board02: {
    type: "PCB Solution",
    num: "BOARD 02",
    title: "RF Power Board",
    sub: "High-Power RF Amplifier",
    image: "/board02.png",
    overview:
      "RF 신호를 목표 출력으로 증폭하기 위한 고출력 전력 보드입니다. 출력 안정성과 보호 기능을 고려하여 설계합니다.",
    features: [
      "고출력 RF 증폭",
      "출력 안정화",
      "전류·온도 보호",
    ...
    specs: [
      ["기능", "RF Power Stage"],
      ["보호", "Protection Circuit"],
      ["모니터링", "Power Monitoring"],
      ["설계", "Custom Design"]
    ],
    applications: [
      "RF 전력 증폭",
  ...
  board03: {
    ...
    sub: "Embedded Main Controller",
    image: "/board03.png",
    overview:
      "장비의 동작 순서와 입출력, 통신을 통합 제어하는 메인 제어 보드입니다. 하드웨어와 펌웨어를 연계하여 개발합니다.",
    features: [
      "MCU 기반 제어",
      "다중 입출력",
      "상태 모니터링",
    ...
    specs: [
      ["제어부", "Embedded MCU"],
      ["통신", "UART / CAN / RS485"],
      ["입출력", "Sensor Interface"],
      ["소프트웨어", "Custom Firmware"]
    ],
    applications: [
      "장비 메인 제어",
      "모터·센서 통합 제어",
