        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-7xl items-center justify-center px-6 text-center">
          <div className="max-w-4xl">
            ...
            <div className="mt-10 flex justify-center gap-4">
              <a href="#contact" className="rounded-full bg-[#22b8cf] px-7 py-3 text-white hover:bg-[#1699ae]">
                상담 문의
              </a>
              <a href="#services" className="rounded-full border px-7 py-3 text-white">
                사업분야 보기
              </a>
            </div>
      ...
      <section id="services" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {services.map((s) => (
              <div key={s.number} className="p-8 bg-white rounded-3xl border hover:shadow-xl transition">
      ...
      <footer className="border-t border-slate-200 bg-[#0a0f1a] text-slate-300">
        <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 text-sm">
          ...
          <div>
            ...
            <div>
              대전광역시 대덕구 신일동로17번길 5 807호<br />
              사업자등록번호 : 242-81-03731<br />
              대표자 : 김영식
            </div>
          </div>
